        ...
        <ClienteLayout>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    {/* Filtros */}
                    <Card className="rounded-2xl shadow-lg border border-blue-100 p-8 mb-8">
                        ...
                        <div className="flex justify-end gap-3 mt-6">
                            <Button
                                ...
                                variant="primary"
                                className="px-8 py-3 shadow-lg hover:shadow-xl transform hover:scale-105"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {departamentos.data.map((departamento) => (
                            <Card key={departamento.id} className="group rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border border-blue-100 transform hover:-translate-y-1">
                                {/* Imagen con overlay */}
                                <div className="relative aspect-w-16 aspect-h-9 bg-gray-200 overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4">
                                        <Badge
                                            ...
                                            className="shadow-lg backdrop-blur-sm ring-2 ring-white"
                                        >
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        {auth.user && auth.user.role === 'cliente' ? (
                                            ...
                                            <Button
                                                ...
                                                variant={departamento.es_favorito ? 'danger' : 'secondary'}
                                                className="px-4"
                                                title={departamento.es_favorito ? 'Quitar de favoritos' : 'Agregar a favoritos'}
                                            >
                                                <svg
                                                    className={`w-6 h-6 ${departamento.es_favorito ? 'text-white fill-current' : 'text-slate-400'}`}
                                        ...
                                        {auth.user && auth.user.role === 'cliente' ? (
                                            ...
                                            <Button
                                                ...
                                                variant="primary"
                                                className="flex-1 justify-center shadow-lg hover:shadow-xl transform hover:scale-105"
                                            >
                                                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {mostrarModalContacto && (
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
                        <Card className="relative mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
                            <div className="mt-3">
