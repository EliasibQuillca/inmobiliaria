    ...
    return (
        <PublicLayout auth={auth}>
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                {/* ================================================ */}
                {/* BANNER IMPRESIONANTE PARA VISITANTES */}
                {/* ================================================ */}
                {!auth.user && (
                            ...
                            <div className="relative z-10 px-8 py-12">
                                <div className="grid lg:grid-cols-2 gap-8 items-center">
                                    ...
                                    <div className="text-white space-y-6">
                                        {/* Badge */}
                                        <div className="inline-flex items-center bg-white bg-opacity-20 backdrop-blur-md rounded-full px-4 py-2 border border-white border-opacity-30">
                                            <span className="animate-pulse w-2 h-2 bg-green-400 rounded-full mr-2"></span>
                                            <span className="text-sm font-semibold">Únete a nuestra comunidad</span>
                                        </div>
                                        ...
                                        <p className="text-xl text-white text-opacity-90 leading-relaxed">
                                            Regístrate <span className="font-bold text-yellow-300">gratis</span> y accede a beneficios exclusivos que harán más fácil tu búsqueda del hogar perfecto.
                                        </p>
                                        
                                        {/* Beneficios en Grid */}
                                        <div className="grid grid-cols-2 gap-4 pt-4">
                                            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300">
                                                <div className="flex items-start space-x-3">
                                                    <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-pink-400 to-red-500 rounded-lg flex items-center justify-center">
                                                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" />
                                                        </svg>
                                                    </div>
                                                    <div>
                                                        <h4 className="font-bold text-sm">Lista de Favoritos</h4>
                                                        <p className="text-xs text-white text-opacity-75">Guarda tus propiedades preferidas</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300">
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-white text-opacity-75">Habla con asesores expertos</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300">
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div>
                                                        <h4 className="font-bold text-sm">Cotizaciones</h4>
                                                        <p className="text-xs text-white text-opacity-75">Solicita presupuestos al instante</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 border border-white border-opacity-20 hover:bg-opacity-20 transition-all duration-300">
                                                <div className="flex items-start space-x-3">
                                                    <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-purple-400 to-indigo-500 rounded-lg flex items-center justify-center">
                                                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                                        </svg>
                                                    </div>
                                                    <div>
                                                        <h4 className="font-bold text-sm">Panel Exclusivo</h4>
                                                        <p className="text-xs text-white text-opacity-75">Gestiona todo en un solo lugar</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
                                            ...
                                            <Link
                                                href="/register"
                                                className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
                                            >
                                            ...
                                            <Link
                                                href="/login"
                                                className="w-full bg-gray-100 hover:bg-gray-200 text-gray-900 px-8 py-3 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center"
                                            >
