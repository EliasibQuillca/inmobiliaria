...
const Dashboard = () => {
    const { user, isCliente, isAsesor, isAdmin } = useAuth();
        ...
        <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
                ...
                <p className="text-gray-600">
                    Desde aquí puedes gestionar tus cotizaciones y reservas.
                </p>
            </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">Ver cotizaciones activas</p>
                        </div>
                    </div>
                </div>
    ...
    const renderAsesorDashboard = () => (
        <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">
                    📊 Panel de Asesor - {user?.nombre}
                </h2>
                <p className="text-gray-600">
                    Gestiona las cotizaciones, reservas y ventas de tus clientes.
                </p>
            </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">Procesar reservas</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-500">Registrar ventas</p>
                        </div>
                    </div>
                </div>
    ...
    const renderAdminDashboard = () => (
        <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">
                    ⚙️ Panel de Administrador - {user?.nombre}
                </h2>
                <p className="text-gray-600">
                    Control total del sistema inmobiliario.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        <div className="p-2 bg-blue-100 rounded-lg">
                            <svg className="w-6 h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H7m2 0v-4a1 1 0 011-1h4a1 1 0 011 1v4z" />
                            </svg>
                        </div>
                        <div className="ml-4">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        <div className="p-2 bg-yellow-100 rounded-lg">
                            <svg className="w-6 h-6 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2-2V7a2 2 0 012-2h14a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 00-2 2v6a2 2 0 01-2 2H9z" />
                            </svg>
                        </div>
                        <div className="ml-4">
                            <h3 className="text-lg font-medium text-gray-900">Transacciones</h3>
                            <p className="text-sm text-gray-500">Supervisar operaciones</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h3 className="text-lg font-medium text-gray-900">Reportes</h3>
                            <p className="text-sm text-gray-500">Análisis del negocio</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h3 className="text-lg font-medium text-gray-900">Auditoría</h3>
                            <p className="text-sm text-gray-500">Logs del sistema</p>
                        </div>
                    </div>
                </div>
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            {isCliente && renderClienteDashboard()}
            {isAsesor && renderAsesorDashboard()}
